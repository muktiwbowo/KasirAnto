...
import com.digitalone.kasiranto.kafe.KafeRenangActivity;
import com.digitalone.kasiranto.kolam.KolamIkanActivity;
import com.digitalone.kasiranto.preferences.SessionManager;
import com.digitalone.kasiranto.toko.TokoActivity;
import com.digitalone.kasiranto.warung.WarungActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()){
            if (session.getLevel().equals("Superuser")){
                ...
                startActivity(new Intent(LoginActivity.this, TokoActivity.class));
                finish();
            }else if (session.getLevel().equals("Warung")){
                startActivity(new Intent(LoginActivity.this, WarungActivity.class));
                finish();
            }else if (session.getLevel().equals("KafeRenang")){
                startActivity(new Intent(LoginActivity.this, KafeRenangActivity.class));
                finish();
            }else if (session.getLevel().equals("KolamIkan")){
                startActivity(new Intent(LoginActivity.this, KolamIkanActivity.class));
                finish();
            }
        }
    }
