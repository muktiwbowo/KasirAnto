package com.digitalone.kasiranto.kolam;
...
public class KolamIkanActivity extends AppCompatActivity {
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(KolamIkanActivity.this, LoginActivity.class);
