...
public class AdapterTransaksiKafe extends RecyclerView.Adapter<AdapterTransaksiKafe.HolderTransKafe> {
    private List<KafeTransaksiItem> items;
    private Context context;
    private DecimalFormat fRupiah;

    public AdapterTransaksiKafe(List<KafeTransaksiItem> items, Context context) {
        this.items = items;
    ...
    @NonNull
    @Override
    public AdapterTransaksiKafe.HolderTransKafe onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterTransaksiKafe.HolderTransKafe holder, int position) {
        KafeTransaksiItem   item = items.get(position);
